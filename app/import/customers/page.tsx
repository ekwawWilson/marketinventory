        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl text-sm font-mono focus:border-blue-500 focus:outline-none resize-y"
            />
          </div>
          ...
          <button
            ...
            className="px-5 py-2.5 border-2 border-blue-500 text-blue-600 rounded-xl font-semibold text-sm hover:bg-blue-50 disabled:opacity-40 disabled:cursor-not-allowed"
          >
            Preview
          </button>
        </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
              ...
              <button
                ...
                className={`px-5 py-2 rounded-xl font-semibold text-sm text-white ${isSubmitting ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'}`}
              >
